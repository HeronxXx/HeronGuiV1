...
SpookyGui.MouseButton1Down:connect(function()
	game.StarterGui:SetCore("SendNotification", {Title = "HERONS SELLER GUI", Text = "Spooky GuiLoaded", Icon = "http://www.roblox.com/asset/?id=344110788", Duration = 5, Button1 = "OK"})
...
HusamDevGui.MouseButton1Down:connect(function()
	game.StarterGui:SetCore("SendNotification", {Title = "HERONS SELLER GUI", Text = "HusamDevGui Loaded", Icon = "http://www.roblox.com/asset/?id=344110788", Duration = 5, Button1 = "OK"})
...
game.StarterGui:SetCore("SendNotification", {Title = "HERONS SELLER GUI", Text = "Admin Base TP Loaded", Icon = "http://www.roblox.com/asset/?id=344110788", Duration = 5, Button1 = "OK"})
...
game.StarterGui:SetCore("SendNotification", {Title = "HERONS SELLER GUI", Text = "Club TPLoaded", Icon = "http://www.roblox.com/asset/?id=344110788", Duration = 5, Button1 = "OK"})
...
game.StarterGui:SetCore("SendNotification", {Title = "HERONS SELLER GUI", Text = "Basket TP Loaded", Icon = "http://www.roblox.com/asset/?id=344110788", Duration = 5, Button1 = "OK"})
